...
void ControllerDriver::RunFrame()
{
	...
	VRDriverLog()->Log("Server: Run Handler"); //this is how you log out Steam's log file.
    float data[2];
    date = server_Handle();
...
float* server_Handle(void){
   ...
   // At this point you can receive datagrams on your bound socket.
   while (result[1] == 0.95){ // Server is receiving data until you will close it.(You can replace while(1) with a condition to stop receiving.)
